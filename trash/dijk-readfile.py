...
if __name__ == '__main__':
    graph = Graph(int(input("node vertice: ")))
    '''
    ...
    '''
    file_name = input("topology檔案名稱: ")
    #fp = open(filename, 'r', encoding = "UTF-8")
    # read topology file and return the value to add_edge() function
    ...
    #graph.show_path(0, 4)
    src = input("src node: ")
    dest = input("dest node: ")
    graph.show_path(int(src), int(dest))
